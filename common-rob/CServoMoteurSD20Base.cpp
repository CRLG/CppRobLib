...
/*!
   ...
   \return --
*/
CServoMoteurSD20Base::CServoMoteurSD20Base()
{
    unsigned char i=0;
...
/*!
   ...
   \return --
*/
void CServoMoteurSD20Base::Init(void)
{
/*
...
/*!
   ...
   \return --
*/
void CServoMoteurSD20Base::CommandePositionVitesse(unsigned char numServo, unsigned int position, unsigned int vitesse)
{
...
/*!
   ...
   \return --
*/
void CServoMoteurSD20Base::CommandePosition(unsigned char numServo, unsigned int position)
{
...
/*!
   ...
   \return --
*/
void CServoMoteurSD20Base::CommandeVitesse(unsigned char numServo, unsigned int vitesse)
{
    if (numServo>NBRE_SERVOS_SD20) { return; }
    if (numServo == 0) { return; }
...
*/
/*
void CServoMoteurSD20Base::GestionTransfert(void)
{
...
/*!
   ...
   \return --
*/
void CServoMoteurSD20Base::setDureeAvantRelache(unsigned char numServo, unsigned int duree_ms)
{
    if (numServo>NBRE_SERVOS_SD20) { return; }
    if (numServo == 0) { return; }
...
/*!
   ...
   \return --
*/
void CServoMoteurSD20Base::setButeesMinMaxPosition(unsigned char numServo, unsigned int butee_min, unsigned int butee_max)
{
...
/*!
   ...
   \return --
*/
void CServoMoteurSD20Base::setButeeMinPosition(unsigned char numServo, unsigned int butee_min)
{
    if (numServo>NBRE_SERVOS_SD20) { return; }
    if (numServo == 0) { return; }
...
/*!
   ...
   \return --
*/
void CServoMoteurSD20Base::setButeeMaxPosition(unsigned char numServo, unsigned int butee_max)
{
    if (numServo>NBRE_SERVOS_SD20) { return; }
    if (numServo == 0) { return; }
...
*/
/*
void CServoMoteurSD20Base::setDureesMinMaxPulseSD20(unsigned int duree_min_us, unsigned int duree_max_us)
{
    char cmd[10];
    unsigned int reg21;
...
/*!
   ...
   \return --
*/
unsigned int CServoMoteurSD20Base::saturePositionButees(unsigned char numServo, unsigned int position, unsigned int butee_min, unsigned int butee_max)
{
