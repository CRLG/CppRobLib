...
//___________________________________________________________________________
 /*!
   ...
   \return --
*/
CAsservissementBase::CAsservissementBase()
{
  Init();
}
...
//___________________________________________________________________________
 /*!
   ...
   \return --
*/
void CAsservissementBase::Init(void)
{
 int i;
...
float CAsservissementBase::Calc_carto_cur(float entree_x, float axe_x[], float axe_z[], int nb_point_x)
{
	unsigned int i=1;
	float sortie=0;
...
void CAsservissementBase::Initialisation_PID(void)
{
	int_terme_prec_distance = 0;
	int_terme_prec_angle = 0;
	int_terme_distance = 0;
...
void CAsservissementBase::Reset_Pas_Cumules(void)
{
...
void CAsservissementBase::Stop_robot(void)
{
...
float CAsservissementBase::saturation(float valeur_ulim, float valeur_min, float valeur_max)
{
float valeur_lim;
...
void CAsservissementBase::LectureCodeurCalculDistance(void)
{
...
void CAsservissementBase::asservissement(void)
{
...
void CAsservissementBase::CalculXY (void)
{
...
void CAsservissementBase::Generateur_trajectoire (void)
{
...
void CAsservissementBase::CalculsMouvementsRobots(void)
{
...
float CAsservissementBase::max(float Inp1, float Inp2)
{
	float Outp;
...
float CAsservissementBase::min(float Inp1, float Inp2)
{
	float Outp;
...
float CAsservissementBase::SAT(float Inp_max, float Inp_min, float Inp)
{
	return 	min(Inp_max,max(Inp,Inp_min));
}


float  CAsservissementBase::BornageAngle(float angle){
    float ret=0;
...
void CAsservissementBase::CommandeMouvementXY(float x, float y)
{
	diag_blocage = 0;
	compteur_diag_blocage = 0;
...
// -------------------------------------
// Décodage de la trame et affectation des variables
void CAsservissementBase::CommandeMouvementDistanceAngle(float distance, float angle)
{
	diag_blocage = 0;
	compteur_diag_blocage = 0;
	Reset_Pas_Cumules();	// Nouvelle commande -> nouvel origine relatif pour éviter les débordements après plusieurs appels ( à mettre avant l'écrasement des consignes)
...
// -------------------------------------
// Décodage de la trame et affectation des variables
void CAsservissementBase::CommandeManuelle(float cde_G, float cde_D)
{
	diag_blocage = 0;
	compteur_diag_blocage = 0;
...
// ----------------------------------------------------------
// Décodage de la trame et affectation des variables 
void CAsservissementBase::CommandeMouvementXY_A(float x, float y)
{
	diag_blocage = 0;
	compteur_diag_blocage = 0;
	Reset_Pas_Cumules();	// Nouvelle commande -> nouvel origine relatif pour éviter les débordements après plusieurs appels ( à mettre avant l'écrasement des consignes)
...
// ----------------------------------------------------------
// Décodage de la trame et affectation des variables
void CAsservissementBase::CommandeMouvementXY_B(float x, float y)
{
	diag_blocage = 0;
	compteur_diag_blocage = 0;
	Reset_Pas_Cumules();	// Nouvelle commande -> nouvel origine relatif pour éviter les débordements après plusieurs appels ( à mettre avant l'écrasement des consignes)
...
// -------------------------------------
// Décodage de la trame et affectation des variables
void CAsservissementBase::CommandeVitesseMouvement(float vit_avance, float vit_angle)
{
...
// ----------------------------------------------------------
// Décodage de la trame et affectation des variables
void CAsservissementBase::CommandeMouvementXY_TETA(float x, float y, float teta)
{
	diag_blocage = 0;
	compteur_diag_blocage = 0;
	Reset_Pas_Cumules();	// Nouvelle commande -> nouvel origine relatif pour éviter les débordements après plusieurs appels ( à mettre avant l'écrasement des consignes)
...
void CAsservissementBase::setPosition_XYTeta(float x, float y, float teta)
{
  X_robot = x;
  X_robot_prec = x;
  Y_robot = y;
...
void CAsservissementBase::setIndiceSportivite(float idx)
{
  Ind_perfo=idx;
}
...
void CAsservissementBase::setCdeMinCdeMax(int min, int max)
{
    cde_min = min;
    cde_max = max;
}
