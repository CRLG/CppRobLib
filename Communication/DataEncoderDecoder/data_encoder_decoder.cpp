...
//___________________________________________________________________________
 /*!
   ...
   \return --
*/
void CDataEncoderDecoder::encode_uint8(unsigned char *buff, unsigned char position, unsigned char data)
{
    buff[position] = data;
}
...
//___________________________________________________________________________
 /*!
   ...
   \return --
*/
void CDataEncoderDecoder::encode_uint16(unsigned char *buff, unsigned char position, unsigned short data)
{
...
//___________________________________________________________________________
 /*!
   ...
   \return --
*/
void CDataEncoderDecoder::encode_uint32(unsigned char *buff, unsigned char position, unsigned long data)
{
...
//___________________________________________________________________________
 /*!
   ...
   \return --
*/
void CDataEncoderDecoder::encode_int8(unsigned char *buff, unsigned char position, signed char data)
{
    buff[position] = data;
}
...
//___________________________________________________________________________
 /*!
   ...
   \return --
*/
void CDataEncoderDecoder::encode_int16(unsigned char *buff, unsigned char position, signed short data)
{
    buff[position]      = (data >> 8)&0xFF;
    buff[position+1]    = (data&0xFF);
}
//___________________________________________________________________________
 /*!
   ...
   \return --
*/
void CDataEncoderDecoder::encode_int32(unsigned char *buff, unsigned char position, signed long data)
{
    buff[position]      = (data >> 24)&0xFF;
    buff[position+1]    = (data >> 16)&0xFF;
    buff[position+2]    = (data >> 8)&0xFF;
...
*/
unsigned char CDataEncoderDecoder::decode_uint8(unsigned char *buff, unsigned char position)
{
...
*/
unsigned long CDataEncoderDecoder::decode_uint32(unsigned char *buff, unsigned char position)
{
...
//___________________________________________________________________________
 /*!
   ...
   \return la data sur 8 bits
*/
signed char CDataEncoderDecoder::decode_int8(unsigned char *buff, unsigned char position)
{
    return buff[position];
}
...
//___________________________________________________________________________
 /*!
   ...
   \return la data sur 16 bits
*/
signed short CDataEncoderDecoder::decode_int16(unsigned char *buff, unsigned char position)
{
    return ( ( ((signed short)(buff[position+1])) & 0xFF) )  |  ( ( ((unsigned short)(buff[position])) & 0xFF) << 8 ) ;
}
...
//___________________________________________________________________________
 /*!
   ...
   \return la data sur 32 bits
*/
signed long CDataEncoderDecoder::decode_int32(unsigned char *buff, unsigned char position)
{
    return ( ( ((signed long)(buff[position+3])) & 0xFF) )  |
            ( ( ((signed long)(buff[position+2])) & 0xFF) << 8 ) |
            ( ( ((signed long)(buff[position+1])) & 0xFF) << 16 ) |
            ( ( ((signed long)(buff[position])) & 0xFF) << 24 );
}
