...
// ==============================================================
// ==============================================================
Message_COMMANDE_MOUVEMENT_XY_B::Message_COMMANDE_MOUVEMENT_XY_B()
{
    m_id = 0x22;
    m_dlc = 6;
}
...
const char* Message_COMMANDE_MOUVEMENT_XY_B::getName()
{
    return "COMMANDE_MOUVEMENT_XY_B";
}
 ...
 */
void Message_COMMANDE_MOUVEMENT_XY_B::decode(const unsigned char *buff_data)
{
 ...
 */
void Message_COMMANDE_MOUVEMENT_XY_B::encode(unsigned char *buff_data)
{
