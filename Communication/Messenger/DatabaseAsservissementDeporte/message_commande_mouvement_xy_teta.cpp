...
// ==============================================================
// ==============================================================
Message_COMMANDE_MOUVEMENT_XY_TETA::Message_COMMANDE_MOUVEMENT_XY_TETA()
{
    m_id = 0x23;
    m_dlc = 8;
}
...
const char* Message_COMMANDE_MOUVEMENT_XY_TETA::getName()
{
    return "COMMANDE_MOUVEMENT_XY_TETA";
}
 ...
 */
void Message_COMMANDE_MOUVEMENT_XY_TETA::decode(const unsigned char *buff_data)
{
 ...
 */
void Message_COMMANDE_MOUVEMENT_XY_TETA::encode(unsigned char *buff_data)
{
